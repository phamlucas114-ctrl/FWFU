A collection of unrelated files, which I hope others find useful
[vi.yml](https://github.com/user-attachments/files/25559365/vi.yml)
setup:
  ^SetupCaption: "Cài đặt $(^Name) v${VERSION}${VERSION_NOTE}"
  ^UninstallCaption: "Gỡ cài đặt $(^Name) v${VERSION}${VERSION_NOTE}"
  SECTION_MAIN: "$(^NameDA) (bắt buộc)"
  SECTION_STARTMENU: "Lối tắt trong Start Menu"
  SECTION_DESKTOP: "Lối tắt trên màn hình Desktop"
  INSTALLER_RUNNING: "Cài đặt $(^Name) đang chạy"
  NON_EMPTY_FOLDER_ERROR: "$(^Name) không thể được cài đặt vào thư mục không trống"
  OPEN_PROGRAM: "&Mở $(^NameDA)"
  CLEANCONFIRM: "&Xóa cài đặt của chương trình"
  INSTALLED_HEADER: "Đã cài đặt"
  INSTALLED_TEXT: "Chọn thao tác cần thực hiện."
  INSTALLED_SAME: "$(^NameDA) v${VERSION} đã được cài đặt. Chọn thao tác bạn muốn thực hiện."
  INSTALLED_OLD: "Phiên bản cũ của $(^NameDA) đã được cài đặt trên hệ thống của bạn. Chọn thao tác bạn muốn thực hiện."
  INSTALLED_NEW: "Phiên bản mới hơn của $(^NameDA) đã được cài đặt! Không khuyến nghị cài đặt phiên bản cũ hơn. Nếu bạn thực sự muốn cài đặt phiên bản cũ này, tốt hơn là gỡ cài đặt phiên bản hiện tại trước. Chọn thao tác bạn muốn thực hiện."
  REINSTALL: "&Cài đặt lại"
  UPDATE: "Cập &nhật"
  UNINSTALL: "&Gỡ cài đặt"
  UNINSTALL_CURRENT: "&Gỡ cài đặt phiên bản hiện tại"
  NO_UNINSTALL: "&Không gỡ cài đặt"
  INSTTYPE_HEADER: "Loại cài đặt"
  INSTTYPE_TEXT: "Chọn loại cài đặt cần thực hiện."
  INSTTYPE_INTRO: "Chào mừng bạn đến với trình hướng dẫn cài đặt $(^NameDA). Để bắt đầu, vui lòng chọn loại cài đặt mong muốn."
  INSTTYPE_STANDARD: "Cài đặt &tiêu chuẩn (khuyến nghị)"
  INSTTYPE_STANDARD_DESC: "Cài đặt $(^NameDA) cho tất cả người dùng trên máy này."
  INSTTYPE_PORTABLE: "Cài đặt &di động"
  INSTTYPE_PORTABLE_DESC: "Giải nén một phiên bản di động của $(^NameDA). Trong chế độ di động, tất cả dữ liệu cấu hình được lưu trữ trong thư mục ứng dụng và không có thông tin nào được ghi vào registry."
  EXTRACTING_FILES: "Đang giải nén tệp... %s"
  INETC_DOWNLOADING: "Đang tải xuống %s"
  INETC_CONNECTING: "Đang kết nối..."
  INETC_SECOND: "giây"
  INETC_MINUTE: "phút"
  INETC_HOUR: "giờ"
  INETC_PROGRESS: "%dkB (%d%%) của %dkB @ %d.%01dkB/s"
  INETC_REMAINING: " (%d %s%s còn lại)"
tray:
  TRAY_OPEN: "Mở &Windhawk"
  TRAY_LOADED_MODS: "Đã tải &mod"
  TRAY_TOOLKIT: "&Bộ công cụ"
  TRAY_EXIT: "&Thoát"
  EXITDLG_TITLE: "Thoát Windhawk"
  EXITDLG_CONTENT: "Windhawk sẽ thoát và tất cả các mod sẽ được dỡ bỏ. Windhawk sẽ tự động khởi động lại vào lần khởi động hệ thống tiếp theo, trừ khi tùy chọn dưới đây được chọn."
  EXITDLG_CHECKBOX_AUTOSTART: "Không tự động khởi động lại vào lần khởi động hệ thống tiếp theo"
  EXITDLG_BUTTON_EXIT: "&Thoát Windhawk"
  EXITDLG_BUTTON_CANCEL: "Hủy"
  NOTIFICATION_UPDATE_APP: "Phiên bản mới của Windhawk có sẵn"
  NOTIFICATION_UPDATE_APP_MOD: "Phiên bản mới của Windhawk có sẵn và một mod có thể được cập nhật"
  NOTIFICATION_UPDATE_APP_MODS: "Phiên bản mới của Windhawk có sẵn và %d mod có thể được cập nhật"
  NOTIFICATION_UPDATE_MOD: "Một mod của Windhawk có thể được cập nhật"
  NOTIFICATION_UPDATE_MODS: "%d mod của Windhawk có thể được cập nhật"
  TRAYICON_TOOLTIP_UPDATE: "Phiên bản mới có sẵn"
  TASKDLG_TITLE_LOADED_MODS: "Các mod đã tải"
  TASKDLG_TITLE_TASKS_IN_PROGRESS: "Các tác vụ mod đang thực hiện"
  TASKDLG_BUTTON_OPEN_APP: "Mở &Windhawk"
  TASKDLG_COLUMN_MOD: "Mod"
  TASKDLG_COLUMN_PROCESS: "Quá trình"
  TASKDLG_COLUMN_PID: "PID"
  TASKDLG_COLUMN_STATUS: "Trạng thái"
  TASKDLG_STATUS_PENDING: "Đang chờ..."
  TASKDLG_STATUS_LOADING: "Đang tải..."
  TASKDLG_STATUS_LOADED: "Đã tải"
  TASKDLG_STATUS_UNLOADED: "Đã dỡ bỏ"
  TASKDLG_TASK_INITIALIZING: "Đang khởi tạo..."
  TASKDLG_TASK_LOADING_SYMBOLS: "Đang tải biểu tượng..."
  TASKDLG_TASK_WAITING_FOR_SYMBOLS: ~
  TASKDLG_TASK_UNINITIALIZING: ~
  TASKDLG_PROCESS_SUSPENDED: "(bị tạm dừng)"
  TOOLKITDLG_TITLE: "Bộ công cụ Windhawk"
  TOOLKITDLG_EXPLANATION_CRASH: "Đã phát hiện hệ thống không ổn định, có thể do một trong các bản mod Windhawk gây ra. Thoát Windhawk hoặc khởi chạy lại ở chế độ an toàn có thể giúp giải quyết vấn đề."
  TOOLKITDLG_BUTTON_OPEN: "&Mở Windhawk"
  TOOLKITDLG_BUTTON_LOADED_MODS: "Đã tải &mod"
  TOOLKITDLG_BUTTON_EXIT: "&Thoát Windhawk"
  TOOLKITDLG_BUTTON_SAFE_MODE: "&Chế độ an toàn"
  TOOLKITDLG_BUTTON_CLOSE: "&Đóng bộ công cụ"
  SAFE_MODE_TITLE: "Khởi động lại ở chế độ an toàn"
  SAFE_MODE_TEXT: "Windhawk sẽ được khởi động lại với tất cả các chức năng tiêm mã đã tắt."
  SAFE_MODE_DETECTED_TITLE: "Chế độ an toàn"
  SAFE_MODE_DETECTED_TEXT: "Windows đang chạy ở chế độ an toàn. Bạn có muốn bật chế độ an toàn trong Windhawk không? Tất cả chức năng tiêm mã sẽ bị tắt."
app:
  general:
    loading: "Đang tải..."
  ...
  website:
    appHeader:
      mods: ~
      links: "Liên kết"
      contributeTranslation: "Đóng góp bản dịch mới"
    home:
      tagline: "Chợ tùy chỉnh cho các chương trình Windows"
      download: ~
      getInvolved: ~
      joinDiscord: ~
      discussWindhawk: ~
